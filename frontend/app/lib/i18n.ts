...
type Dict = {
  ...
  home: { titlePre: string; titleWord: string; streak: string; level: (n: number) => string; milestone: (n: number) => string };
...
const STRINGS: Record<Locale, Dict> = {
  es: {
    ...
    home: { titlePre: "Conecta el", titleWord: "mundo", streak: "racha", level: (n) => `⚡ Nivel ${n}`, milestone: (n) => `¡Racha de ${n} días! Sigue así 🔥` },
    subdivisionNoun: {
  ...
  en: {
    ...
    comingSoon: "coming soon",
    home: { titlePre: "Connect the", titleWord: "world", streak: "streak", level: (n) => `⚡ Level ${n}`, milestone: (n) => `${n}-day streak! Keep it going 🔥` },
    subdivisionNoun: {
  ...
  pt: {
    ...
    comingSoon: "em breve",
    home: { titlePre: "Conecte o", titleWord: "mundo", streak: "sequência", level: (n) => `⚡ Nível ${n}`, milestone: (n) => `Sequência de ${n} dias! Continue assim 🔥` },
    subdivisionNoun: {
      department: { one: "departamento", many: "departamentos" },
      state: { one: "estado", many: "estados" },
  ...
  fr: {
    ...
    comingSoon: "bientôt",
    home: { titlePre: "Relie le", titleWord: "monde", streak: "série", level: (n) => `⚡ Niveau ${n}`, milestone: (n) => `Série de ${n} jours ! Continue 🔥` },
    subdivisionNoun: {
