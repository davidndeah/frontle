...
const STRINGS: Record<Locale, Dict> = {
  es: {
    ...
    payNoGas: "Tu wallet se quedó sin CELO para la comisión de red. El gas de bienvenida ya se agotó; necesitas un poco de CELO en tu wallet para pagar pistas o reintentos.",
  ...
  en: {
    ...
    payNoGas: "Your wallet ran out of CELO for the network fee. Your welcome gas is used up; you need some CELO in your wallet to pay for hints or retries.",
  ...
  pt: {
    ...
    payNoGas: "Sua carteira ficou sem CELO para a taxa de rede. O gás de boas-vindas acabou; você precisa de um pouco de CELO na carteira para pagar dicas ou novas tentativas.",
    footer: "Frontle · Hackathon de Agentes Onchain · Celo Colombia",
    hintsTitle: "Dicas",
  ...
  fr: {
    ...
    payNoGas: "Votre portefeuille n'a plus de CELO pour les frais de réseau. Le gaz de bienvenue est épuisé ; il vous faut un peu de CELO dans votre portefeuille pour payer des indices ou des essais.",
