...
const E: RegionEntity[] = [
  ...
  { name: "La Pampa", code: "pam", neighbors: ["Buenos Aires", "Córdoba", "Mendoza", "Río Negro", "San Luis"] },
  { name: "La Rioja", code: "rio", neighbors: ["Catamarca", "Córdoba", "San Juan", "San Luis"] },
  { name: "Mendoza", code: "men", neighbors: ["La Pampa", "Neuquén", "San Juan", "San Luis"] },
  { name: "Misiones", code: "mis", neighbors: ["Corrientes"] },
  { name: "Neuquén", code: "neu", neighbors: ["Mendoza", "Río Negro"] },
  { name: "Río Negro", code: "rion", neighbors: ["Buenos Aires", "Chubut", "La Pampa", "Neuquén"] },
